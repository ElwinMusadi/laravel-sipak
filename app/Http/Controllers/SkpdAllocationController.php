...
class SkpdAllocationController extends Controller
{
  ...
  /**
   * @return array{id: int, box: array{id: int, box_number: string}, loket: array{id: int, name: string}, numerator_start: int, numerator_end: int, quantity: int, used_quantity: int, remaining_quantity: int, status: string, created_by: string, created_at: string, accepted_by: string|null, accepted_at: string|null, can: array{accept: bool, cancel: bool}}
   */
