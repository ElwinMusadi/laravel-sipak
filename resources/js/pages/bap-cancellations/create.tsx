            ...
            <main className="flex min-w-0 flex-1 flex-col gap-6 p-4 sm:p-6">
                <div className="grid gap-2">
                    ...
                    <div className="grid gap-1.5">
                        ...
                        <p className="text-muted-foreground max-w-2xl text-sm">
                            Nomeratur harus sudah menjadi bagian pemakaian BAP
                            ini. Pencatatan tidak mengembalikan stock maupun
                            alokasi.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid max-w-5xl gap-6 xl:grid-cols-[minmax(0,1fr)_18rem]">
                    <Card>
                        ...
                        <CardContent>
                            <Form
                                {...SkpdBapCancellationController.store.form(
                                    bap.id,
                                )}
                    ...
                    <div className="grid content-start gap-4">
                        ...
                        <Card>
                            ...
                            <CardContent className="grid gap-2 text-sm">
                                <p>
                                    Total pemakaian BAP tetap{' '}
                                    {formatQuantity(bap.total_usage)} set.
                                </p>
                                <p className="text-muted-foreground">
                                    Klasifikasi ini tidak mengubah inventory,
                                    sisa alokasi, atau ketersediaan nomeratur.
                                </p>
                            </CardContent>
                        </Card>
                    </div>
