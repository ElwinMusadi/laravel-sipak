      ...
      <main className="flex min-w-0 flex-1 flex-col gap-6 p-4 sm:p-6">
        <div className="grid gap-1.5">
          ...
          <p className="text-muted-foreground max-w-2xl text-sm">
            Riwayat nomeratur yang telah dipakai tetapi diklasifikasikan sebagai
            batal atau rusak.
          </p>
        </div>
          ...
          <CardContent>
            ...
            >
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setReason(
                    value === "all" ? "" : (value as CancellationReason),
                  )
                }
              >
                <SelectTrigger
                ...
                <Table className="min-w-300">
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Keterangan singkat</TableHead>
                    ...
                    {cancellations.data.map((cancellation) => (
                      <TableRow key={cancellation.id}>
                        ...
                        <TableCell className="whitespace-nowrap">
                          {formatDate(cancellation.service_date)}
                        </TableCell>
                        <TableCell>{cancellation.loket}</TableCell>
                        ...
                        <TableCell>{cancellation.created_by}</TableCell>
                        <TableCell>
                          <BapStatusBadge status={cancellation.bap_status} />
                        </TableCell>
        ...
        <div className="flex flex-col justify-between gap-3 text-sm sm:flex-row sm:items-center">
          <p className="text-muted-foreground">
            Menampilkan {cancellations.from ?? 0}–{cancellations.to ?? 0} dari{" "}
            {cancellations.total} record
          </p>
